...
X_train = np.load('{}_mse_im{}_X_train.npy'.format(dataset, group))
y_train = np.load('{}_mse_im{}_dmos_train.npy'.format(dataset, group))
X_test = np.load('{}_mse_im{}_X_test.npy'.format(dataset, group))
y_test = np.load('{}_mse_im{}_dmos_test.npy'.format(dataset, group))
X_val = np.load('{}_mse_im{}_X_val.npy'.format(dataset, group))
y_val = np.load('{}_mse_im{}_dmos_val.npy'.format(dataset, group))
...
np.save('{}_im{}_MSE_result_train'.format(dataset, group), result1)
np.save('{}_im{}_MSE_result_test'.format(dataset, group), result2)
np.save('{}_im{}_MSE_result_val'.format(dataset, group), result3)
np.save('{}_im{}_MSE_eval'.format(dataset, group), evl)