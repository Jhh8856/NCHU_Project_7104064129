...
firstsmx = NASNetMobile(input_shape=None,
                include_top=True,
                weights=None,
                input_tensor=None,
                pooling=None,
...
np.save('classify_result_train_NASNet', result1)
np.save('classify_result_test_NASNet', result2)
np.save('classify_result_val_NASNet', result3)
