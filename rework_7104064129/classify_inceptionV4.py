...
firstsmx = create_model(num_classes=4, dropout_prob=0.4)
...
#save
plt.savefig('{}x{}_{}patches_inception.pdf'.format(input_shape[0], input_shape[1], patch_count))
firstsmx.save('classify_inception.hdf5')
np.save('classify_result_train_inception', result1)
np.save('classify_result_test_inception', result2)
np.save('classify_result_val_inception', result3)
np.save('classify_eval_inception', evl)