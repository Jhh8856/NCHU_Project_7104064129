...
folder_path = './MCL_3D'
data_path = folder_path + '/_release_201401/rendered_left_and_right/' #把.mat檔複製到這
...
X_train, X_test, y_train, y_test = train_test_split(dataset, group, random_state=seed, shuffle=True,
                                                    train_size=0.8)  # spilt dataset
X_train, X_val, y_train, y_val = train_test_split(X_train, y_train, random_state=seed, shuffle=True,
                                                  train_size=0.875)  # 0.8*0.875=0.7

X_train_reg, X_test_reg, y_train_reg, y_test_reg = train_test_split(dataset_bin, dmos, random_state=seed, shuffle=True,
                                                                    train_size=0.8)
X_train_reg, X_val_reg, y_train_reg, y_val_reg = train_test_split(X_train_reg, y_train_reg, random_state=seed,
                                                                  shuffle=True, train_size=0.875)
