function [net, info] = cnn_cla(varargin)
...
opts.expDir = fullfile(vl_rootnn, 'data\test\classification\binary\0519\sfm-4g\sco\g1') ;
[opts, varargin] = vl_argparse(opts, varargin) ;
 

opts.imdbPath = fullfile(opts.expDir, 'im1.mat');
opts.train = struct() ;
...
net = firstsmx('networkType', opts.networkType) ;
