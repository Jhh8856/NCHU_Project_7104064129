  ...
  switch l.type
    ...
    case 'dropout'
      ...
      res(i+1).x = tee(res(i).x, l.class) ;
        ...
        res(i).dzdx = bo_sof(res(i).x, l.class) ;
                   end
    case 'bnorm'
      if testMode
    ...
    case 'custom'
      ...
      res(i+1).x = custom(res(i).x) ;
      
      case 'reshape'
          res(i+1).x = vl_nnreshape(res(i).x) ;
  ...
  for i=n:-1:max(1, n-opts.backPropDepth+1)
    ...
    switch l.type
      ...
      case 'te'
        ...
        res(i).dzdx = te(res(i).x, l.class, res(i+1).dzdx) ;
                   end
         case 'tee'
                   if testMode
        res(i+1).x = res(i).x ;
      else
        res(i).dzdx = tee(res(i).x, l.class, res(i+1).dzdx) ;
                   end
           case 'sof'
                   if testMode
        res(i+1).x = res(i).x ;
      else
        res(i).dzdx = bo_sof(res(i).x, l.class, res(i+1).dzdx) ;
                   end        
      ...
      case 'custom'
        ...
        res(i+1).x = custom(res(i).x, res(i+1).dzdx) ;
