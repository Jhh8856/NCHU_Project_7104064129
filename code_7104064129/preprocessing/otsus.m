...
elseif n~=abs(round(n)) || n==0
    error('MATLAB:otsu:WrongNValue n must be a strictly positive integer!')
elseif n>255
    n = 255;
...
%% Perform a KLT if is RGB, and keep the component of highest energy
if isRGB
    sizI = size(I);
    I = reshape(I,[],3);
    [V,D] = eig(cov(I));
...
%% Maximal sigma B^2 and Segmented image
if n==2
    sigma2B =...
